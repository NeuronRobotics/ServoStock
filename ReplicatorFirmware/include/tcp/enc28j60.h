...
#ifdef TCP_USE_SPI_2
#error "BOTH SPIs Defined: Please define either TCP_USE_SPI1 or TCP_USE_SPI2 in TCPIP-BSD-Config.h"
#endif
...
#else
#error "NO SPIs defined: Please define either TCP_USE_SPI1 or TCP_USE_SPI2 in TCPIP-BSD-Config.h"
#endif
#endif
