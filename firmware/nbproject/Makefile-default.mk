...
SOURCEFILES_QUOTED_IF_SPACED=src/driver/AS5055.c src/driver/ForgeHeater.c src/driver/SPIClient.c src/driver/FlashStorageLocal.c src/driver/Servo.c src/kinematics/KosselKinematics.c src/kinematics/delta.c src/kinematics/FrogLegs.c src/kinematics/CartesianController.c src/motion/Calibration.c src/motion/StepperSim.c src/motion/PID.c src/namespace/Namespace_bcs_cartesian.c src/namespace/Namespace_bcs_rtd.c src/main.c
...
# Source Files
SOURCEFILES=src/driver/AS5055.c src/driver/ForgeHeater.c src/driver/SPIClient.c src/driver/FlashStorageLocal.c src/driver/Servo.c src/kinematics/KosselKinematics.c src/kinematics/delta.c src/kinematics/FrogLegs.c src/kinematics/CartesianController.c src/motion/Calibration.c src/motion/StepperSim.c src/motion/PID.c src/namespace/Namespace_bcs_cartesian.c src/namespace/Namespace_bcs_rtd.c src/main.c
